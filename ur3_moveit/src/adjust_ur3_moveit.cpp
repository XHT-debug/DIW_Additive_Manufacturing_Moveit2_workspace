...
int main(int argc, char ** argv)
{
	...
	auto pressure_active_adjust_control_pub = move_group_node->create_publisher<std_msgs::msg::Int32>("/pressure_active_adjust_control", 10);
	...
	// 将气压进口关闭 
	std_msgs::msg::Int32 msg_pressure_control, msg_pressure_active_adjust_control;
    ...
    msg_pressure_active_adjust_control.data = 1;
    pressure_active_adjust_control_pub->publish(msg_pressure_active_adjust_control);
	...
	// 将气压进口关闭 
	msg_pressure_active_adjust_control.data = 0;
    pressure_active_adjust_control_pub->publish(msg_pressure_active_adjust_control);
